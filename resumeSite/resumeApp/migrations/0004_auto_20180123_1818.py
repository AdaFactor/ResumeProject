# Generated by Django 2.0.1 on 2018-01-23 18:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('resumeApp', '0003_remove_letter_attachments2'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, max_length=400)),
                ('time_period', models.CharField(max_length=32)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=10), size=2)),
                ('birthday', models.CharField(max_length=10)),
                ('nationality', models.CharField(max_length=16)),
                ('religion', models.CharField(max_length=16)),
                ('age', models.IntegerField(default=0)),
                ('activity', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=32), size=10)),
                ('hobbie', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=32), size=10)),
                ...
                ('letter', models.ManyToManyField(related_name='student_letter', to='resumeApp.Letter')),
        ...
        migrations.AddField(
            model_name='branch',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resumeApp.Course'),
        ),
    ]
