...
class Letter(models.Model):
    ...
    major_choices = (
        ('สังคม', 'สำนักวิชาเทคโนโลยีสังคม'),
        ('เกษตร', 'สำนักวิชาเทคโนโลยีเกษตร'),
        ('วิศวะ', 'สำนักวิชาวิศวกรรมศาสตร์'),
        ('สาธา', 'สำนักวิชาสาธารณสุขศาสตร์'),
        ('วิทย์', 'สำนักวิชาวิทยาศาสตร์'),
    )
    brance_choices = (
        ('ไอที', 'สาขาวิชาเทคโนโลยีสารสนเทศ'),
        ('ผลิตพืช', 'สาขาวิชาเทคโนโลยีการผลิตพืช'),
        ('ผลิตสัตว์', 'สาขาวิชาเทคโนโลยีการผลิตสัตว์'),
        ('อาหาร', 'สาขาวิชาเทคโนโลยีอาหาร'),
        ('เกษตร', 'สาขาวิชาวิศวกรรมเกษตร'),
        ('ขนส่ง', 'สาขาวิชาวิศวกรรมขนส่งและโลจิสติกส์'),
        ('คอม', 'สาขาวิชาวิศวกรรมคอมพิวเตอร์'),
        ('เครื่องกล', 'สาขาวิชาวิศวกรรมเครื่องกล'),
        ('เซรามิก', 'สาขาวิชาวิศวกรรมเซรามิก'),
        ('โทรคม', 'สาขาวิชาวิศวกรรมโทรคมนาคม'),
        ('อิเล็ก', 'สาขาวิชาวิศวกรรมอิเล็กทรอนิกส์'),
        ('พอลิเมอร์', 'สาขาวิชาวิศวกรรมพอลิเมอร์'),
        ('ไฟฟ้า', 'สาขาวิชาวิศวกรรมไฟฟ้า'),
        ('โยธา', 'สาขาวิชาวิศวกรรมโยธา'),
        ('โลหะ', 'สาขาวิชาวิศวกรรมโลหการ'),		
        ('สิ่งแวดล้อม', 'สาขาวิชาวิศวกรรมสิ่งแวดล้อม'),		
        ('อุตสา', 'สาขาวิชาวิศวกรรมอุตสาหการ'),		
        ('ธรณี', 'สาขาวิชาเทคโนโลยีธรณี'),		
        ('การผลิต', 'สาขาวิชาวิศวกรรมการผลิต'),		
        ('อนามัยสิ่งแวดล้อม', 'สาขาวิชาอนามัยสิ่งแวดล้อม'),		
        ('อนามัย', 'สาขาวิชาอาชีวอนามัยและความปลอดภัย'),		
        ('กีฬา', 'สาขาวิชาวิทยาศาสตร์การกีฬา'),		
        ('คณิต', 'สาขาวิชาคณิตศาสตร์'),		
        ('เคมี', 'สาขาวิชาเคมี'),		
        ('ชีวะ', 'สาขาวิชาชีววิทยา'),		
        ('ฟิสิกส์', 'สาขาวิชาฟิสิกส์'),		
    )
    ...
    # major_list = models.CharField(max_length=64, choices=major_choices, default='สังคม')
    # brance_list = models.CharField(max_length=64, choices=brance_choices, default='ไอที')    
